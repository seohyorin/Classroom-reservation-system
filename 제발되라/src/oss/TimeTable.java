...
public class TimeTable {
    ...
    public TimeTable(String classnumber, String time, boolean classState){
    ...
    static class SetClassInfo{
        ...
        public void SetTimeTable(String classnumber){
            ...
            for (TimeTable setclas : setclass) {
                if (setclas.classnumber.equals(classnumber)) {
                    System.out.println("[호실: " + setclas.classnumber + " | 시간: " + 
                    setclas.time + " | 예약상태:" + setclas.CheckState() + "]");
                }
            }
        }
    }   
